  ...
  onSubmit = e => {
    ...
    axios
      ...
      .then(res => {
        ...
        sessionStorage.setItem("userimg", res.data.user.profile.image);
        sessionStorage.setItem("contacts", res.data.user.profile.contacts);
        sessionStorage.setItem("invites", res.data.user.profile.contacts);
        this.setState({
          redirect: true
        });
      })
